 ...
 */
final class Version20231025145259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD auteur_id INT DEFAULT NULL, ADD author VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP auteur_id, DROP author');
    }
}
