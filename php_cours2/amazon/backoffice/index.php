        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./form/form_produit.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Creation d'un produit</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Produit(s)</h1>
                    </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Créateur : <?php echo $i['firstname'] . " " . $i['lastname']; ?></div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $i['title'] ?>
                                                </div>
                                            </div>
                                            <div class="col-auto">
