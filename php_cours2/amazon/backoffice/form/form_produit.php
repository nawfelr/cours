...
if (!empty($_POST)) {
    if (!empty($_POST['title']) && !empty($_POST['price']) && !empty($_POST['description']) && !empty($_FILES['image']) && !empty($_POST['stock']) && !empty($_POST['id_category'])) {
        ...
        $sqlInsertProduct = "INSERT INTO `product`(`title`, `price`, `description`,`image_produit`, `stock` , `id_user`,`discount`,`id_category`) VALUES ('$title','$price','$description','$image','$stock','$id_user','$discount','$id_category')";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./form_produit.php">
                    <i class="fas fa-fw fa-table"></i>
