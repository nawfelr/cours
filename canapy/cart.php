					...
					<div class="site-blocks-table">
						...
						<?php if (!empty($tableCart)) { ?>
							...
							<table class="table">
								...
								<tbody>
									<?php include('component/article_panier.php'); ?>
						...
						<?php } else {
							echo "<h2 style:'color:black; text-align:center;'> VOTRE PANIER EST VIDE </h2>";
						} ?>
