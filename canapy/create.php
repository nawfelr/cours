...
require_once('lib/class_article.php');
...
if ($_SESSION['power'] == 1) {
    ...
    if (!empty($_POST)) {
        ...
        if (!empty($_POST['title']) && !empty($_POST['price']) && !empty($_FILES['image'])) {
            ...
            if ($article->insertArticle($title, $price, $image, $id_user)) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="lname" name="price">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
