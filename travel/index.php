    ...
    <div class="owl-banner owl-carousel">
      <div class="banner-item-01">
        <div class="text-content">
          <h4>Les Meilleurs Offres</h4>
          <h2>Nouveautés</h2>
        </div>
      </div>
      <div class="banner-item-02">
        <div class="text-content">
          <h4>Voyages de qualités</h4>
          <h2>Faites vos plus beaux voyages</h2>
        </div>
      </div>
      <div class="banner-item-03">
        <div class="text-content">
          <h4>Offres Flash</h4>
          <h2>Profitez de nos offres flash</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
            ...
            <a href="products.php">Voir tous nos voyages <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
  ...
  <div class="best-features">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
            <h2> À propos de Travel</h2>
          </div>
        </div>
        <div class="col-md-6">
          <div class="left-content">
            <h4>À la recherche de l'éxperience de votre vie ?</h4>
